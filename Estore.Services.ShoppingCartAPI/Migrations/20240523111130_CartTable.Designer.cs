...
namespace Estore.Services.ShoppingCartAPI.Migrations
{
    ...
    [Migration("20240523111130_CartTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estore.ShoppingCartAPI.Models.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("Estore.ShoppingCartAPI.Models.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estore.ShoppingCartAPI.Models.CartDetails", b =>
                {
                    b.HasOne("Estore.ShoppingCartAPI.Models.CartHeader", "CartHeader")
                        .WithMany()
