...
using System;
using System.Collections.Generic; // Import the namespace for IEnumerable
using System.Linq; // Import the namespace for ToList method

namespace EStore.Services.CouponAPI.Controllers
{
